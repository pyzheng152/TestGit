...
public class BankInfo {
  ...
  //二分查找方法  
    ...
    public static String getBankName(String accountNo){
    	return BankInfo.getNameOfBank(accountNo.toCharArray(), 0);
//    	return BankInfo.getNameOfBank(accountNo.substring(0,6).toCharArray(), 0);
    }
	/**
	 * @param args
	 */
	...
	public static void main(String[] args) {
		...
		String cN = "42702001234";
		String name = BankInfo.getNameOfBank(cardNumber, 0);
		System.out.println(name);
		System.out.println(BankInfo.getNameOfBank(cN.toCharArray(), 0));
		System.out.println(BankInfo.getBankName(cN));
	}
*/
}
